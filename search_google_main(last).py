...
# ㄴ완료
# sel_num=0 이면 지도에 필요한 좌표를 보내줌
# sel_num=1 이면 GUI에 필요한 리스트를 보내줌
#############################################################################################################################

def search(input_search_locations=[], sel_num=0):
    ...
    if(sel_num==0): # 0 이면 지도에 필요한 좌표를 보내줌
        return result_location # 지도로 보내줄 좌표
    elif(sel_num==1): # 1 이면 GUI에 필요한 리스트를 보내줌
